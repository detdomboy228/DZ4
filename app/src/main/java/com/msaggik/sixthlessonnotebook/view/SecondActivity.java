...
public class SecondActivity extends AppCompatActivity {
    ...
    private FloatingActionButton fabAdd, fabDelete; // поле для кнопки добавить новую заметку
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // удаление всех записей БД и перезагрузка активности
        fabDelete.setOnClickListener(listener -> {
            // условие, чтобы вхолостую не перезагружать активность
